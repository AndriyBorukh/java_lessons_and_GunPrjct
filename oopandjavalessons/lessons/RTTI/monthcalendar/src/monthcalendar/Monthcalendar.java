...
public class Monthcalendar {
	...
	{	
	  console_printer.printlnstringtoconsole("do you want to see current month type yes or no, or end for exit  ");
	  Scanner in = new Scanner(System.in);
	  command= in.next();
	  if (command.contentEquals("yes"))
	   {
             
               console_printer.printlnstringtoconsole (daysname); 
          ...
          if (command.contentEquals("no"))
	   {
             try
              {
                console_printer.printlnstringtoconsole("enter year and month");
                int year = in.nextInt();
		...
		newcalendar.ShowCalendar(year, month);   
                 ...
                 {console_printer.printlnstringtoconsole("\033[31m  wrong year or month!  \u001B[0m");}	  
           }
	}
    } 
}
